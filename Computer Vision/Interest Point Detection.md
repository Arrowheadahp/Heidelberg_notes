...
3. Discretization (ex: spatial resolution, focus)

Points are better for this role because corners are easier to pinpoint in a image than line segment which can be anywhere on the line. Point detection is better than line detection
