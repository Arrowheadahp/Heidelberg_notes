...
The filters are separable, we can use the Associative [[Properties of Convolution]] for decomposing the filter into 1d vectors. This is possible for all [[List of Convolution Filters]] like 
1. [[Box Filter]]
2. [[Gaussian Filter]]
3. [[Sobel Filter]]
4. [[Corner Filter]]
