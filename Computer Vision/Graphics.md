...
> Instead of shooting rays from the light source, we shoot rays from the camera ([[Helmholtz Reciprocity]]) and approximate the pixel colour from the multiple rays using Monte Carlo Simulations.
