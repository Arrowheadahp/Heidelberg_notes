This is a type of [[Iterative Estimation Methods]], where we try to find the global minima/maxima of a neural network using chain rule. 
...
2. Iterate k times
	...
	2. Average gradient over all examples using [[Gradient Descent]].
